...
//获取APP版本
export const getAppVersion = (data, callback) =>post('appplus.checkversion', data, callback);
...
//忘记密码
export const userForgetpwdApi = (data, callback) => post('user.forgetpwd2', data, callback);

//重设支付密码
export const updatePaypwd = (data, callback) => post('user.resetpwd', data, callback);

//验证支付密码
export const authPaypwd = (data, callback) => post('user.authpwd', data, callback);
...
//酒豆列表
export const getDouLstApi = (data, callback) => post('dou.getlst', data, callback);

export const dtoexpApi = (data, callback) => post('dou.dtoexp', data, callback);
export const dtobalanceApi = (data, callback) => post('dou.dtobalance', data, callback);
