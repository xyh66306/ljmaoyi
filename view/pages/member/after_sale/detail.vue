	...
	<view class="content">
		<view class="content-top">
			...
			<view class='cell-group margin-cell-group'>
				...
				<view class='cell-item' v-if="status == 1 || status == 3">
					<view class='cell-item-hd'><view class='cell-hd-title item-des'>可退代金券(整单退完，退还全部代金券)</view></view>
					<view class='cell-item-ft'><view class="cell-ft-p red-price">{{refund_points||'0'}}代金券</view></view>
				</view>
				<view class='cell-item' v-if="status == 2">
					<view class='cell-item-hd'><view class='cell-hd-title'>已退代金券</view></view>
					<view class='cell-item-ft'><view class="cell-ft-p red-price">{{refund_points||'0'}}代金券</view></view>
				</view>
			</view>
	...
	onLoad(options) {
		...
		this.$api.afterSalesInfo(data, res => {
			if(res.status){
				...
				this.refund_points = info.points_refunded
				if(info.mark){
					this.mark = info.mark;
				}
				if(info.status == 1){
