<template>
	<view class="content">
		<uni-segmented-control :current="current" :values="items" @clickItem="onClickItem" style-type="text" active-color="#fda14a"></uni-segmented-control>
		...
		<view class="coupon-none" v-else>
			<image class="coupon-none-img" src="/static/img/order-empty.png" mode=""></image>
		</view>
	</view>
</template>
