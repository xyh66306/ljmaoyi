<template>
	<view class="content">
		<view class="cell-group margin-cell-group">
			<view class="cell-item">
				...
				<view class="cell-item-ft">
					...
					<text class="cell-ft-p" v-if="type == 10">代金券订单</text>
		...
		<!-- #ifdef H5 -->
		<payments-by-h5 :orderId="orderId" :recharge="recharge" :type="type" :uid="userInfo.id" :exp="exp"></payments-by-h5>
		<!-- #endif -->

		<!-- #ifdef MP-WEIXIN -->
		<payments-by-wx :orderId="orderId" :recharge="recharge" :type="type" :uid="userInfo.id" :exp="exp"></payments-by-wx>
		<!-- #endif -->

		<!-- #ifdef MP-ALIPAY -->
		<payments-by-ali :orderId="orderId" :recharge="recharge" :type="type" :uid="userInfo.id" :exp="exp"></payments-by-ali>
		<!-- #endif -->

		<!-- #ifdef APP-PLUS || APP-PLUS-NVUE -->
		<payments-by-app :orderId="orderId" :recharge="recharge" :type="type" :uid="userInfo.id" :exp="exp"></payments-by-app>
		<!-- #endif -->

		<!-- #ifdef MP-TOUTIAO -->
		<payments-by-tt :orderId="orderId" :recharge="recharge" :type="type" :uid="userInfo.id" :exp="exp"></payments-by-tt>
		<!-- #endif -->
	</view>
</template>
<script>
