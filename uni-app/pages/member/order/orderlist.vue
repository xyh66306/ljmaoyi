	...
	<view class="content">
		...
		<view class="order-list">
					...
					<view class='cell-group'>
						<view class='cell-item'>
							<view class='cell-item-ft goods-num'>
								...
								<text class='cell-ft-text' v-else>合计<text class="red-price">￥ {{ item.order_amount }}+ {{ item.point }} 积分</text></text>
			...
			<view class="order-none" v-else>
				<image class="order-none-img" src="/static/img/shop/empty.png" mode=""></image>
			</view>
		</view>
	</view>
</template>
