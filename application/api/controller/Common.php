...
class Common extends Api
{
    ...
    public function jshopConf()
    {
        ...
        if (!Cache::has("jshop_jshopconf")) {
            ...
            $conf['point_rule_id']       = $config['point_rule_id'];         //积分规则
            $conf['shop_beian']          = $config['shop_beian'];            //备案
            $conf['language']            = getSetting('language');           //语言包，预留的口
            $conf['open_point_exchange'] = $config['open_point_exchange'];   //是否开启积分兑换
    ...
    public function getCaptcha()
    {
        ...
        return captcha($id, ['isCross' => true, 'seKey' => 'jihainet.com']);
    }
