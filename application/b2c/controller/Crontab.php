...
class Crontab extends Base
{
    ...
    /**
     * 取消订单
     * 访问地址：http://你的域名/b2c/crontab/cancle
    ...
    /**
     * 订单自动完成
     * 访问地址：http://你的域名/b2c/crontab/complete
    ...
    /**
     * 自动评价订单
     * 访问地址：http://你的域名/b2c/crontab/evaluate
     * @throws \think\Exception
     * @throws \think\db\exception\DataNotFoundException
     * @throws \think\db\exception\ModelNotFoundException
     * @throws \think\exception\DbException
    ...
    /**
     * 订单自动签收
     * 访问地址：http://你的域名/b2c/crontab/sign
     * @throws \think\db\exception\DataNotFoundException
     * @throws \think\db\exception\ModelNotFoundException
     * @throws \think\exception\DbException
     */
    ...
    /**
     * 催付款
     * 访问地址：http://你的域名/b2c/crontab/remind
     * @throws \think\db\exception\DataNotFoundException
     * @throws \think\db\exception\ModelNotFoundException
     * @throws \think\exception\DbException
     */
    ...
    /**
     * 拼团自动取消到期团，每分钟执行一次
     * 访问地址：http://你的域名/b2c/crontab/pintuanCancle
     * @throws \think\db\exception\DataNotFoundException
     * @throws \think\db\exception\ModelNotFoundException
     * @throws \think\exception\DbException
     */
    ...
    /**
     * 定期清理7天前操作日志
     * 访问地址：http://你的域名/b2c/crontab/removeOpLog
     * @return false|string
     * @throws \think\Exception
     * @throws \think\exception\PDOException
     */
    ...
    /**
     * 砍价活动过期的状态变更
     * 访问地址：http://你的域名/b2c/crontab/bargainCancle
     */
