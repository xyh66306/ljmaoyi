<template>
	<view class="content">
				...
				<view class="price-salesvolume" v-if="lasttime.hour !== false">
					...
					<view class="commodity-time" v-if="goodsInfo.pintuan_rule.pintuan_start_status == 2">
						...
						<view class="commodity-day">
							<uni-countdown
								textColor="#fce250"
								:day="goodsInfo.pintuan_rule.lasttime.day"
								:hour="goodsInfo.pintuan_rule.lasttime.hour"
								:minute="goodsInfo.pintuan_rule.lasttime.minute"
								:second="goodsInfo.pintuan_rule.lasttime.second"
							></uni-countdown>
						</view>
					</view>
									...
									<view class="cell-item-bd">
										...
										<view class="cell-bd-view">
											<view class="commodity-day">
												...
												<uni-countdown
													color="#666"
													:day="item[0].remainder_time.day"
													:hour="item[0].remainder_time.hour"
													:minute="item[0].remainder_time.minute"
													:second="item[0].remainder_time.second"
												></uni-countdown>
											</view>
										</view>
									</view>
									<view class="cell-item-ft"><button class="btn" @click="toshow(11, item[0].team_id)">去拼单</button></view>
								</view>
									...
									<view class="cell-item-bd">
										...
										<view class="cell-bd-view">
											<view class="commodity-day">
												...
												<uni-countdown
													color="#666"
													:day="item[1].remainder_time.day"
													:hour="item[1].remainder_time.hour"
													:minute="item[1].remainder_time.minute"
													:second="item[1].remainder_time.second"
												></uni-countdown>
											</view>
										</view>
									</view>
									<view class="cell-item-ft"><button class="btn" @click="toshow(11, item[1].id)">去拼单</button></view>
								</view>
							</view>
						</swiper-item>
					</swiper>
			...
			<view class="ig-top" v-if="teamInfo.list.length > 0">
				<view class="ig-top-t">
					<view class="">
						剩余时间：
						<uni-countdown
							:day="teamInfo.team_time.day"
							:hour="teamInfo.team_time.hour"
							:minute="teamInfo.team_time.minute"
							:second="teamInfo.team_time.second"
						></uni-countdown>
					</view>
				</view>
				<view class="ig-top-m">
				...
				<view class="ig-top-b">
					...
					<view class="igtb-mid"><button class="btn" @click="toshow(11, teamInfo.id)" v-if="teamInfo.team_nums && teamInfo.team_nums > 0">参与拼团</button></view>
				</view>
			</view>
		</lvv-popup>
		...
		<view class="goods-bottom">
			...
			<!-- #endif -->
			<!-- #ifdef MP-WEIXIN -->
			<button class="goods-bottom-ic weiContact" hover-class="none" @click="showQwChat" :session-from="kefupara" v-if="openQiyeWeixin">
				<image class="icon" src="/static/image/customerservice.png" mode=""></image>
				<view>客服</view>
			</button>

			<button class="goods-bottom-ic weiContact" hover-class="none" open-type="contact" bindcontact="showChat" :session-from="kefupara" v-else>
				<image class="icon" src="/static/image/customerservice.png" mode=""></image>
				<view>客服</view>
			</button>
			...
			<button class="btn btn-square btn-b" @click="toshow(11)" hover-class="btn-hover2" v-if="goodsInfo.pintuan_rule.pintuan_start_status == 1">
				<view class="btn-content">
...
import { apiBaseUrl, corpId, openQiyeWeixin, extInfoUrl } from '@/config/config.js';
...
.commodity-time-img {
	...
	width: 0;
	height: 0;
	border-width: 56rpx 28rpx 56rpx 0;
	border-style: solid;
