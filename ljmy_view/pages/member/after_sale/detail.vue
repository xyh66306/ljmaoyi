		...
		<view class="content-top">
			...
			<view class='cell-group margin-cell-group'>
				...
				<view class='cell-item' v-if="status == 1 || status == 3">
					<view class='cell-item-hd'><view class='cell-hd-title item-des'>可退积分(整单退完，退还全部积分)</view></view>
					<view class='cell-item-ft'><view class="cell-ft-p red-price">{{refund_points||'0'}}积分</view></view>
				</view>
				<view class='cell-item' v-if="status == 2">
					<view class='cell-item-hd'><view class='cell-hd-title'>已退积分</view></view>
					<view class='cell-item-ft'><view class="cell-ft-p red-price">{{refund_points||'0'}}积分</view></view>
				</view>
			</view>
